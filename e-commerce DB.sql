...
VALUES 
(NULL,'Alice', 'alice@example.com', '123 Elm St'),
(NULL,'Bob', 'bob@example.com', '456 Oak Ave'),
(NULL,'Charlie', 'charlie@example.com', '789 Pine Rd'),
(NULL,'John Doe', 'john@example.com', '123 Main St, Anytown'),
(NULL,'Jane Smith', 'jane@example.com', '456 Oak Ave, Somewhere');

-- Insert orders details
INSERT INTO orders (order_id,customer_id, order_date, total_amount) 
VALUES
(NULL, 1, '2025-05-05', 39.97),
...
INSERT INTO products (product_id,products_name,products_price,products_description)
VALUES 
(NULL, 'Product A', 29.97, 'High-quality widget'),
